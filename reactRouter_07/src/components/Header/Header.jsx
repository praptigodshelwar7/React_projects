            ...
            <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-7xl">
                    ...
                    <div className='flex items-center lg:order-2'>
                        <Link to="#" className=' text-white bg-orange-700 hover:bg-orange-800 focus:ring-orange-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none'>
                        Login
                        </Link>
                        <Link to="#" className='text-white bg-orange-700 hover:bg-orange-800 focus:ring-orange-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none'>
                        Get Started
                    ...
                    <div 
                    className="hidden justify-between items-center w-full lg:flex lg:order-1"
                    id="mobile-menu-2">
